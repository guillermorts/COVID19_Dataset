...
class Italy:
    ...
    def get_all_data(self):   
        import Assistant
        self.casosActivos = Assistant.getCases('Italy','Active Cases')
        self.casosDiarios = Assistant.getCases('Italy','Daily New Cases')
        self.DecesosDiarios = Assistant.getCases('Italy','Daily New Deaths')
        self.RecuperacionesDiarias = Assistant.getCases('Italy','Newly Recovered')
